...
async function getCastumersCred(key) {
  ...
  console.log(
    "this is the usser json file content" + JSON.stringify(castumersConfig)
  );
  let usserCred = {};
  ...
  if (usserCred) {
    ...
    return [
      usserCred.WizcloudApiDBName,
      usserCred.WizcloudApiServer,
      usserCred.WizcloudApiPrivateKey,
    ];
...
function generateKey() {
  ...
  if (apikeys[hashedKey]) generateKey();
